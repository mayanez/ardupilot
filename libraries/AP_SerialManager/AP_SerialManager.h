...
#define AP_SERIALMANAGER_SHEAD_BAUD 115200
#define AP_SERIALMANAGER_SHEAD_BUFSIZE_RX 512 // NOTE: Refer to
                                              // Packet::MAX_PACKET_LEN
#define AP_SERIALMANAGER_SHEAD_BUFSIZE_TX 512
#endif
